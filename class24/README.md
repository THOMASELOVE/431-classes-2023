...
2. I added three packages (`xfun`, `epibasix` and `exact2x2`) to the [list of recommended R packages to install](https://github.com/THOMASELOVE/431-packages/tree/main). I'll use all three in today's class.
3. Quiz 2 materials will be completely posted **by 5 PM today**. Visit <https://github.com/THOMASELOVE/431-quizzes-2023/tree/main/quiz2>.
...
4. Class 25 on Tuesday 2023-12-05 will be given **via Zoom** rather than in person, and some of it will be an "Ask Me Anything" session.
5. Feedback on the Minute Paper after Class 23 will be posted **by class time**.
6. An Answer Sketch for Lab 7 will be posted **by class time**.
7. With regard to Lab X, I will post a video of myself creating and posting a basic website no later than December 7.
