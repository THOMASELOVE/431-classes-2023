...
2. [Lab 1](https://github.com/THOMASELOVE/431-labs-2023/tree/main) is due Tuesday 2023-09-12 at NOON.
    - I have created a brief Zoom recording called **How Dr Love would get started on Lab 1**, specifically, how I would build my response using Quarto. The recording is available through Zoom ... Course Recordings on [Canvas](https://canvas.case.edu/). Please take a look if you're having any trouble getting started. I apologize if my image in the video obscures anything.
