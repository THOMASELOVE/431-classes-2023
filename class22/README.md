...
3. Grades and feedback on Project A should be in your hands **today**.
    - You should receive (via your **CWRU email**) a link from me to a Google Doc of feedback that only you and I can see. [My template is here](https://docs.google.com/document/d/1QDEKCvSiZcnBJQD7OcG9lfTthF3AQes_wgD4ETvIJyw/edit?usp=sharing).
